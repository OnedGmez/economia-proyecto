<template>
    <div @scroll="scrollOn" class="rentacar">
        <div class="pagina">
...
import menuCelular from '@/components/complementos-componentes/menu-celular.vue';
...
@media (max-width: 768px) {
    ...
    .pagina .estatica-top .cabecera .busqueda .filtro-btn {
        margin: auto 0 auto 15px;
    }

    .pagina .estatica-top .cabecera .busqueda .filtro-btn .icono-boton {
