<template>
    <div v-if="vista == 'Home'" class="col-sm-6 col-md-4 col-lg-3 contenedor-tarjeta">
        ...
        <div v-if="vista == 'Rentacar'" @click="mostrarDetalles" class="card">
            <div class="d-flex card-body">
                <div class="img-carro">
                    <img src="https://imrrsmkwbhsldwcxgoqv.supabase.co/storage/v1/object/public/digital-economy-file-server/photos/cars/carro_prueba.png" alt="img"
                        class="img-fluid">
                </div>
...
.card .card-body .distancia, .zona-informacion .categoria-tipo-carro, .anio-carro {
    color: #8e8e8e;
